...
// FetchSymbol return symbol
func (c *Client) SubscribeToOrderBookFor(symbol string) (oBooks chan subscribeOrderBookResponse, doneChan chan struct{}, err error) {
	u := url.URL{
	...
	oBooks = make(chan subscribeOrderBookResponse)
